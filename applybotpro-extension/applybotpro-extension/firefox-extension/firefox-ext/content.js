...
async function activateAutoFill(jobId) {
  ...
  if (CONFIG.FEATURES.DEBUG_MODE) {
    console.log('[ApplyBotPro] Activated. Job:', jobId, '| Profile:', userProfile?.name);
  }
}
  ...
  panel.innerHTML = `
    <div class="applybotpro-panel-header">
      <div style="display:flex;align-items:center;gap:8px">
        ...
        <span style="font-weight:700;font-size:15px">ApplyBotPro</span>
      </div>
    ...
    <div class="applybotpro-panel-content">
      ${notLoggedIn ? `
        <div class="applybotpro-status" style="border-left:3px solid #EF4444">
          ...
          <p style="font-size:12px;color:#666;margin-top:4px">Log in to ApplyBotPro to enable autofill.</p>
  ...
  try {
    ...
    if (res?.success) {
      resultsDiv.innerHTML = `
        <div class="applybotpro-success">
          ✓ Application saved!
          <p class="applybotpro-tip">Track it in your Applications tab on ApplyBotPro.</p>
        </div>
      `;
    } else {
...
if (CONFIG.FEATURES.DEBUG_MODE) console.log('[ApplyBotPro] Content script ready');
