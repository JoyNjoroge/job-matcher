// Background Service Worker — ApplyBotPro Extension
...
chrome.runtime.onInstalled.addListener(async () => {
  console.log('[ApplyBotPro] Extension installed v1.1');
  await syncAuthToken();
});
...
async function syncAuthToken() {
  try {
    // 1. Ask any open ApplyBotPro tab to read localStorage for us
...
// The Gemini/OpenAI key stays on the server — never exposed in the extension.
